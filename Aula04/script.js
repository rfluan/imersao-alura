...
[ok] Criar uma condição para não adicionar filmes repetidos, caso eles já tenham sido adicionados anteriormente
[ok] Criar um campo e botão para adicionar a imagem pela tela, e não direto no código
